...
const Customer = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editId) {
        await axios.put(
          `https://creditmate-backend.onrender.com/api/customer/update/${editId}`,
          {
            name,
            phone,
          },
        ...
        await axios.post(
          "https://creditmate-backend.onrender.com/api/customer/create",
          {
            name,
            phone,
          },
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await axios.delete(`https://creditmate-backend.onrender.com/api/customer/delete/${id}`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
  ...
  const getCustomerBalance = async (customerId) => {
    try {
      const response = await axios.get(
        `https://creditmate-backend.onrender.com/api/transaction/balance/${customerId}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
